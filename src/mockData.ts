...
export const MOCK_TRADES: Trade[] = [
  ...
  { id: 't5',  account_id: 'a2', strategy_id: 's1', symbol: 'NQ',  direction: 'long',  trade_date: d(7),  pnl:  3400, size: 2, stop_loss_pts: 20, take_profit_pts: 80, htf_pd_array: 'W FVG',  psychology: 'Patient', notes: 'Perfect entry', confirmations: { 'Turtle Soup': true, '5m IFVG': true, 'OTE': true, 'Liquidity Taken': true }, field_values: {}, source: 'topstepx' },
  { id: 't6',  account_id: 'a2', strategy_id: 's2', symbol: 'CL',  direction: 'short', trade_date: d(8),  pnl: -1200, size: 1, stop_loss_pts: 30, take_profit_pts: 60, htf_pd_array: '4H OB',  psychology: 'Rushed',  notes: '', confirmations: {}, field_values: {}, source: 'topstepx' },
  ...
  { id: 't13', account_id: 'a2', strategy_id: 's1', symbol: 'NQ',  direction: 'long',  trade_date: d(15), pnl:  1900, size: 1, stop_loss_pts: 20, take_profit_pts: 60, htf_pd_array: '4H FVG', psychology: 'Focused', notes: '', confirmations: { 'Turtle Soup': true, '5m IFVG': true }, field_values: {}, source: 'topstepx' },
  ...
  { id: 't16', account_id: 'a2', strategy_id: 's2', symbol: 'ES',  direction: 'long',  trade_date: d(21), pnl:  -900, size: 1, stop_loss_pts: 20, take_profit_pts: 40, htf_pd_array: '4H OB',  psychology: 'Distracted', notes: '', confirmations: {}, field_values: {}, source: 'topstepx' },
  ...
  { id: 't19', account_id: 'a2', strategy_id: 's1', symbol: 'NQ',  direction: 'short', trade_date: d(28), pnl: -2200, size: 2, stop_loss_pts: 22, take_profit_pts: 55, htf_pd_array: '4H OB',  psychology: 'Overconfident', notes: 'Counter trend — mistake', confirmations: {}, field_values: {}, source: 'topstepx' },
