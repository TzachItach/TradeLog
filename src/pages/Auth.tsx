...
import { signInWithGoogle, signInWithApple, DEMO_MODE } from '../lib/supabase';
    ...
    <div className="auth-wrap">
      ...
      <div className="auth-card" dir={lang === 'he' ? 'rtl' : 'ltr'}>
        ...
        {!DEMO_MODE ? (
          ...
          <div style={{ background: 'rgba(74,125,255,.08)', border: '1px solid rgba(74,125,255,.2)', borderRadius: 8, padding: '10px 14px', marginBottom: 18, fontSize: '.8rem', color: 'var(--t2)' }}>
            {lang === 'he'
              ? '⚡ מצב הדגמה פעיל — Supabase לא מוגדר. נתוני ה-demo יאוחסנו בדפדפן.'
              : '⚡ Demo mode active — Supabase not configured. Demo data stored in browser.'}
          </div>
        )}
