    ...
    <div className="auth-wrap">
      ...
      <div className="auth-card" dir={isHe ? 'rtl' : 'ltr'}>
        <div className="auth-logo">
          <img src={darkMode ? '/logo.png?v=2' : '/logo-light.png?v=2'} alt="TraderYo" style={{ width: 180, height: 'auto', objectFit: 'contain', margin: '0 auto 8px', display: 'block', borderRadius: 20 }} />
        </div>
