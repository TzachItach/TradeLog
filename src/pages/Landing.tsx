...
const T = {
  he: {
    ...
    footerPhone: '054-615-0818',
    footerEmail: 'support@tradereport.co.il',
  },
  en: {
      ...
      <footer className="lp-footer">
        <div className="lp-footer-cols">
          ...
          <div className="lp-footer-col">
            ...
            <ul className="lp-footer-col-links">
              <li>
                <a href={`https://wa.me/972${t.footerPhone.replace(/-/g,'').replace(/^0/,'')}`} target="_blank" rel="noopener noreferrer" className="lp-footer-contact-row">
